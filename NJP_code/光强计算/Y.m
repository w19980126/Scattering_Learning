function [ Ymn ] = Y( n,m,theta,phi )
%Y Summary of this function goes here
%   Detailed explanation goes here
% siz=[360,2];
% [YY,THETA,PHI]=spharm4(n,m,siz,0);
% [~,I]=maxMinI(@min,abs(THETA-theta*ones(siz)')+abs(PHI-phi*ones(siz)'));
% Ymn=YY(I(1),I(2));

[Ymn]=spharm4_my(n,m,theta,phi);
...
function [Ymn]=spharm4_my(L,M,THETA,PHI)
